...
function HomePageLinks({
    ...
    return(
        ...
        :
            <div className="nav">
                <Button inverted className="nav--link" onClick={() => navigate('/profile')}>Mon profil</Button>
                <Button inverted className="nav--link" onClick={handleLogout}>Déconnexion</Button>
            </div>
    );
}
